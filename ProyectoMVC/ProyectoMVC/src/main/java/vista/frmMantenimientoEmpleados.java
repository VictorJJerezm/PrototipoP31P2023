...
public class frmMantenimientoEmpleados extends javax.swing.JInternalFrame {
    ...
    public void llenadoDeTablas() {
        ...
        for (int i = 0; i < listaEmpleados.size(); i++) {
            ...
            dato[2] = listaEmpleados.get(i).getCodigoPuesto();
            dato[3] = listaEmpleados.get(i).getCodigoDepartamento();
            dato[4] = listaEmpleados.get(i).getEstatusEmpleado();
            modelo.addRow(dato);
        }       
    }
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(label5)
                                .addGap(29, 29, 29)
                                .addComponent(txtEstatus, javax.swing.GroupLayout.PREFERRED_SIZE, 64, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(label3)
                                    .addComponent(label6)
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                        .addComponent(txtCodigoD, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 98, Short.MAX_VALUE)
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        registrosBorrados=empleado.setBorrarEmpleados(empleado);
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        clsEmpleado empleados = new clsEmpleado();
        empleados.setNombreEmpleado(txtNombre.getText());
        empleados.setCodigoPuesto(txtCodigop.getText());
        empleados.setCodigoDepartamento(txtCodigoD.getText());
        empleados.setEstatusEmpleado(txtEstatus.getText());
        empleados.setIngresarEmpleados(empleados);
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        // TODO add your handling code here:
        clsEmpleado empleados = new clsEmpleado();        
        empleados.setCodigoEmpleado(Integer.parseInt(txtbuscado.getText()));        
        empleados = empleados.getBuscarInformacionEmpleadosPorId(empleados);
        System.out.println("Aplicacion retornada:" + empleados);        
        txtNombre.setText(empleados.getNombreEmpleado());
        txtCodigop.setText(empleados.getCodigoPuesto());
        txtCodigoD.setText(empleados.getCodigoDepartamento());
        txtEstatus.setText(empleados.getEstatusEmpleado());
...
//        // TODO add your handling code here:
        ...
        empleados.setCodigoDepartamento(txtCodigoD.getText());
        empleados.setEstatusEmpleado(txtEstatus.getText());
        empleados.setModificarEmpleados(empleados);
